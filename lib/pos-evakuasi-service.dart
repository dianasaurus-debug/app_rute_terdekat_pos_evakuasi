...
class PoskoEvakuasiService{
  ...
  getBencanaBaru() async{
    var fullUrl = _url + 'bencana-baru';
  ...
  getDesiredPosko(posko) async{
    var nama_posko = posko.replaceAll(" ", "%20");
    var fullUrl = 'https://graphhopper.com/api/1/geocode?q=$nama_posko&locale=in_ID&debug=true&key=44dcc408-6c03-4675-ac78-863c0051be57';
    return await http.get(
      Uri.parse(fullUrl),
    );
  }
